...
<template>
  ...
  <main>
    ...
    <section>
      <h2>How To Analyze Data Using BenQual</h2>

      <div class="method">
        <h3>Method 1: Inputting Number Values</h3>
        <p>
          <span class="bold">Step 1:</span> Go to the
      ...
      <div class="method">
        <h3>Method 2: Uploading a Document</h3>
        <p>
          <span class="bold">Step 1:</span> Go to the
          <RouterLink to="/analyze">Analysis page</RouterLink>
        </p>
